...
console.log('📝 POST /v2/droplets Responses:\n')
    ...
    if (content?.schema) {
      ...
      if ('$ref' in schema) {
        ...
        if (resolved.properties) {
          ...
          // Check for droplet/droplets
          if (resolved.properties.droplet) {
            console.log('  ✓ Has "droplet" property (single)')
          }
          if (resolved.properties.droplets) {
            console.log('  ✓ Has "droplets" property (multiple)')
          }
          if (resolved.properties.links) {
            console.log('  ✓ Has "links" property')
          }
        }
