...
1. Generates TypeScript types from OpenAPI specs
2. Updates package.json exports
3. Bundles the code
...
# Bug fix
git commit -m "fix: correct OpenAPI parsing for nested objects"
...
fix: resolve OpenAPI parsing issue with arrays
...
```bash
# Build (this auto-generates types)
pnpm build

# Verify files were created
ls openapi-specs/your-api-name/
# Should show: your-api.json, types.d.ts
...
describe('Your API Integration', () => {
  it('should have types file', () => {
    const typesPath = join(SPECS_DIR, 'your-api-name/types.d.ts')
